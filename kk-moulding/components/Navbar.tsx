    ...
    <>
      <nav
        ...
        style={{
          ...
          backdropFilter: scrolled || menuOpen ? 'none' : 'none',
          borderBottom: scrolled ? '1px solid #E6D5C3' : '1px solid transparent',
        }}
      >
        <div className="container-editorial flex items-center justify-between py-4 lg:py-6">
          {/* Logo */}
          <Link href="/" className="font-serif text-xl tracking-[0.15em] uppercase text-[#3E2723] z-50">
            K K Moulding
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <button className="text-[#3E2723] ml-2">
        ...
        <div
          ...
          style={{ paddingTop: '80px', backgroundColor: '#FFFFFF' }}
        >
      ...
      {/* Spacer to prevent overlap since nav is fixed */}
      <div className="h-[73px] lg:h-[88px] w-full" />
    </>
  );
}
